...
#define MSOLEDBSQL_VER 1900
#endif

#if MSOLEDBSQL_VER >= 1900

#define MSOLEDBSQL_PRODUCT_NAME_FULL_ANSI          "Microsoft OLE DB Driver 19 for SQL Server"
#define MSOLEDBSQL_PRODUCT_NAME_SHORT_ANSI         "OLE DB Driver 19 for SQL Server"

#define MSOLEDBSQL_FILE_NAME_ANSI                  "msoledbsql19"
#define MSOLEDBSQL_FILE_NAME_FULL_ANSI             "msoledbsql19.dll"

#define MSOLEDBSQL_PRODUCT_NAME_FULL_UNICODE       L"Microsoft OLE DB Driver 19 for SQL Server"
#define MSOLEDBSQL_PRODUCT_NAME_SHORT_UNICODE      L"OLE DB Driver 19 for SQL Server"

#define MSOLEDBSQL_FILE_NAME_UNICODE               L"msoledbsql19"
#define MSOLEDBSQL_FILE_NAME_FULL_UNICODE          L"msoledbsql19.dll"

#define MSOLEDBSQL_VI_PROG_ID_ANSI                 "MSOLEDBSQL19"
#define MSOLEDBSQL_VI_ERROR_LOOKUP_PROG_ID_ANSI    "MSOLEDBSQL19.ErrorLookup"
#define MSOLEDBSQL_VI_ENUMERATOR_PROG_ID_ANSI      "MSOLEDBSQL19.Enumerator"

#define MSOLEDBSQL_PROG_ID_ANSI                    "MSOLEDBSQL19.1"
#define MSOLEDBSQL_ERROR_LOOKUP_PROG_ID_ANSI       "MSOLEDBSQL19.ErrorLookup.1"
#define MSOLEDBSQL_ENUMERATOR_PROG_ID_ANSI         "MSOLEDBSQL19.Enumerator.1"

#define MSOLEDBSQL_VI_PROG_ID_UNICODE              L"MSOLEDBSQL19"
#define MSOLEDBSQL_VI_ERROR_LOOKUP_PROG_ID_UNICODE L"MSOLEDBSQL19.ErrorLookup"
#define MSOLEDBSQL_VI_ENUMERATOR_PROG_ID_UNICODE   L"MSOLEDBSQL19.Enumerator"

#define MSOLEDBSQL_PROG_ID_UNICODE                 L"MSOLEDBSQL19.1"
#define MSOLEDBSQL_ERROR_LOOKUP_PROG_ID_UNICODE    L"MSOLEDBSQL19.ErrorLookup.1"
#define MSOLEDBSQL_ENUMERATOR_PROG_ID_UNICODE      L"MSOLEDBSQL19.Enumerator.1"

#define MSOLEDBSQL_CLSID                           CLSID_MSOLEDBSQL19
#define MSOLEDBSQL_ERROR_CLSID                     CLSID_MSOLEDBSQL19_ERROR
#define MSOLEDBSQL_ENUMERATOR_CLSID                CLSID_MSOLEDBSQL19_ENUMERATOR

#endif  // MSOLEDBSQL_VER >= 1900
...
EXTERN_C const IID IID_IUMSInitialize;
    ...
    typedef struct IUMSInitializeVtbl
    {
        ...
        DECLSPEC_XFGVIRT(IUMSInitialize, Initialize)
...
EXTERN_C const IID IID_ISQLServerErrorInfo;
    ...
    typedef struct ISQLServerErrorInfoVtbl
    {
        ...
        DECLSPEC_XFGVIRT(ISQLServerErrorInfo, GetErrorInfo)
...
EXTERN_C const IID IID_IRowsetFastLoad;
    ...
    typedef struct IRowsetFastLoadVtbl
    {
        ...
        DECLSPEC_XFGVIRT(IRowsetFastLoad, InsertRow)
        HRESULT ( STDMETHODCALLTYPE *InsertRow )( 
            IRowsetFastLoad * This,
            /* [in] */ HACCESSOR hAccessor,
            /* [in] */ void *pData);
        
        DECLSPEC_XFGVIRT(IRowsetFastLoad, Commit)
...
EXTERN_C const IID IID_ISchemaLock;
    ...
    typedef struct ISchemaLockVtbl
    {
        ...
        DECLSPEC_XFGVIRT(ISchemaLock, GetSchemaLock)
        ...
        DECLSPEC_XFGVIRT(ISchemaLock, ReleaseSchemaLock)
...
EXTERN_C const IID IID_IBCPSession;
    ...
    typedef struct IBCPSessionVtbl
    {
        ...
        DECLSPEC_XFGVIRT(IBCPSession, BCPColFmt)
        ...
        DECLSPEC_XFGVIRT(IBCPSession, BCPReadFmt)
        HRESULT ( STDMETHODCALLTYPE *BCPReadFmt )( 
            IBCPSession * This,
            /* [string][in] */ const wchar_t *pwszFormatFile);
        
        DECLSPEC_XFGVIRT(IBCPSession, BCPWriteFmt)
...
EXTERN_C const IID IID_IBCPSession2;
    ...
    typedef struct IBCPSession2Vtbl
    {
        ...
        DECLSPEC_XFGVIRT(IBCPSession2, BCPSetBulkMode)
...
EXTERN_C const IID IID_ISSAbort;
    ...
    typedef struct ISSAbortVtbl
    {
        ...
        DECLSPEC_XFGVIRT(ISSAbort, Abort)
...
EXTERN_C const IID IID_ISSDataClassification;
    ...
    typedef struct ISSDataClassificationVtbl
    {
        ...
        DECLSPEC_XFGVIRT(ISSDataClassification, GetSensitivityClassification)
...
EXTERN_C const IID IID_ISSCommandWithParameters;
    ...
    typedef struct ISSCommandWithParametersVtbl
    {
        ...
        DECLSPEC_XFGVIRT(ISSCommandWithParameters, GetParameterProperties)
        /* [local] */ HRESULT ( STDMETHODCALLTYPE *GetParameterProperties )( 
            ISSCommandWithParameters * This,
            /* [out][in] */ DB_UPARAMS *pcParams,
            /* [size_is][size_is][out] */ SSPARAMPROPS **prgParamProperties);
        
        DECLSPEC_XFGVIRT(ISSCommandWithParameters, SetParameterProperties)
...
EXTERN_C const IID IID_ISSAsynchStatus;
    ...
    typedef struct ISSAsynchStatusVtbl
    {
        ...
        DECLSPEC_XFGVIRT(ISSAsynchStatus, WaitForAsynchCompletion)
...
#define SSPROP_INIT_HOST_NAME_CERTIFICATE        33
#define SSPROP_INIT_SERVER_CERTIFICATE           34
...
extern const GUID OLEDBDECLSPEC CLSID_MSOLEDBSQL19            = {0xee5de99aL,0x4453,0x4c96,{0x86,0x1c,0xf8,0x83,0x2a,0x7f,0x59,0xfe}};
extern const GUID OLEDBDECLSPEC CLSID_MSOLEDBSQL19_ERROR      = {0x35ccbc30L,0x32b8,0x465f,{0x90,0xe3,0x32,0x19,0x72,0xa0,0x1a,0xd3}};
extern const GUID OLEDBDECLSPEC CLSID_MSOLEDBSQL19_ENUMERATOR = {0x18f55f9eL,0xd665,0x4d62,{0xa6,0xa8,0xd1,0x3f,0xb4,0x6d,0xa8,0x80}};
